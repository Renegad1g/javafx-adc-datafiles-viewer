...
public class RootLayoutController implements Initializable {
    ...
    private static Optional<Callback<Window, Window>> mCallback = Optional.empty();
    ...
    public static void onLoad(Callback<Window, Window> r) {
        RootLayoutController.mCallback = Optional.of(r);
    }
    ...
    private void handleOpenMenuItem() {
        ...
        //
        mCallback.ifPresent(o -> o.call(dialogStage.getScene().getWindow()));
        if (file != null) {
            openFile(file);
        }
    }
...
//        mChannelsArrayList = MainApp.getChannelsData(file.getAbsolutePath().toLowerCase().replaceAll(".dat", ""));
//        System.out.println(mChannelsArrayList.get(0).getDataItem(0));
        String filePathString = file.getAbsolutePath().toLowerCase().replaceAll(".dat", "");
